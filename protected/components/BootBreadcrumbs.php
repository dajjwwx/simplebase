	...
	*/
	...
	public function run()
	{
		...
		if($this->homeLink===null)
			$links[]='<li>'.CHtml::link(Yii::t('zii','Home'),array('default/index')).'</li>';
		...
		foreach($this->links as $label=>$url)
		{
			if(is_string($label) || is_array($url))
				...
				$links[]='<li class="active">'.str_replace('{label}',$this->encodeLabel ? CHtml::encode($url) : $url,$this->inactiveLinkTemplate).'</li>';
		}
