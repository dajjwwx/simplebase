...
class CodeMirrorWidget extends CWidget
{
   ...
   {
        foreach($this->syntax as $k=>$syntax){
...
SCRIPT;
   	//	$script = 'var  '.$this->editor. ' = CodeMirror(document.getElementById("'.$this->id.'"),'. CJavaScript::encode($this->_options).')';
		...
		Yii::app()->getClientScript()->registerScript('ext-editor-CodeMirrorWidget'.$this->id,$script,CClientScript::POS_END);
   }
