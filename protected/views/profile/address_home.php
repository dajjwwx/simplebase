...
<div id="regionContent">
	<div id="regionNav">
		<a href="<?php echo $this->createUrl('/profile/regioninfo',array('id'=>0));?>" onclick="eaddress($(this));return false;">家乡</a>
	</div>
	<div id="regionNode">
		<?php echo Region::model()->generateRegionLinks(0, '/profile/regioninfo',array('onclick'=>'eaddress($(this));return false;'))?>
	</div>
