...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'stars',array('size'=>60,'maxlength'=>100,'alt'=>Tag::TAG_STAR,'value'=>'你是大米，玉米？是凉粉还是冰粉？你丫喜欢啥星？','class'=>'span-13  poshy','title'=>'喜欢的明星')); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'food',array('size'=>60,'maxlength'=>100,'alt'=>Tag::TAG_FOOD,'value'=>'什么东西让你丫一想到就流哈喇子呢？泡菜，羊肉泡膜还是……','class'=>'span-13  poshy','title'=>'喜欢的美食')); ?>
		<div class="selectItems">
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'music',array('size'=>60,'maxlength'=>100,'alt'=>Tag::TAG_MUSIC,'value'=>'你丫喜欢什么类型的音乐？R&B，乡村民乐，还是……','class'=>'span-13  poshy','title'=>'喜欢的音乐')); ?>
		<div class="selectItems">
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'movie',array('size'=>60,'maxlength'=>100,'alt'=>Tag::TAG_MOVIE, 'value'=>'你喜欢哪些电影？哪种类型？武侠，美国大片，还是……','class'=>'span-13  poshy','title'=>'喜欢的影视')); ?>
		<div class="selectItems">
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'games',array('size'=>60,'maxlength'=>100,'alt'=>Tag::TAG_GAME,'value'=>'你平时玩网游，单机版的小游戏？','class'=>'span-13  poshy','title'=>'喜欢的游戏')); ?>
		<div class="selectItems">
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'sports',array('size'=>60,'maxlength'=>100,'alt'=>Tag::TAG_SPORT,'value'=>'你平时喜欢一些什么样的运动？蓝球，乒乓球，游泳……','class'=>'span-13  poshy','title'=>'喜欢的运动')); ?>
		<div class="selectItems">
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'books',array('size'=>60,'maxlength'=>100,'alt'=>Tag::TAG_BOOK,'value'=>'你平时看书吗？不管生活节奏有多快，平时有多忙，一定要多看一点书噢～','class'=>'span-13  poshy','title'=>'喜欢的的书籍')); ?>
		<div class="selectItems">
	...
	<hr class="space" />
	<div class="row">
		<?php echo $form->labelEx($model,'tourism'); ?>
		<?php echo $form->textField($model,'tourism',array('size'=>60,'maxlength'=>100,'alt'=>Tag::TAG_TOURISM,'value'=>'每一个人都有一个向往的圣地，你的圣地在何方？','class'=>'span-13  poshy','title'=>'喜欢的旅游圣地')); ?>
		<div class="selectItems">
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'digital',array('size'=>60,'maxlength'=>100,'alt'=>Tag::TAG_DIGIT,'value'=>'你喜欢摄影吗？想要一款好的手机吗？你会特别想要什么品牌的数码产品呢？','class'=>'span-13  poshy','title'=>'喜欢的数码产品')); ?>
		<div class="selectItems">
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'others',array('size'=>60,'maxlength'=>100,'alt'=>Tag::TAG_OTHER,'value'=>'你还有其他的什么爱好吗？与大家分享一下呸','class'=>'span-13  poshy','title'=>'其他的爱好')); ?>
		<div class="selectItems">
