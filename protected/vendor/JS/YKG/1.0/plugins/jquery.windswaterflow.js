...
//                console.log(data);
        ...
        if (param.scroll && param.ajaxServer != '' && param.boxParam != '' && parseInt(param.scrollBoxNumber) > 0) {
            $(window).scroll(function() {
                var scrollh = document.body.scrollHeight - param.distanceFooter;
                var clienth = document.documentElement.clientHeight;
                var scrollt = document.documentElement.scrollTop + document.body.scrollTop;
                
                
//                var temp = {'scrollh':scrollh,'clienth':clienth,'scrollt':scrollt, '_SolStatus':_SolStatus,'_init':_init,'_isnoShow':_isnoShow};
//                console.log(temp);
