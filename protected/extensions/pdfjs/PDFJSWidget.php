 ...
 *@use 
 */
class PDFJSWidget extends CWidget
{
	public $clientScript;
	
	public $baseUrl;
	public $Jscripts = array('web/compatibility.js','build/pdf.js','web/debugger.js','web/viewer.js');
	public $Cssscript = array('web/viewer.css',);	
	public $id = 'PDFJSWidget';
...
SCRIPT;
		Yii::app()->getClientScript()->registerScript('ext_pdfjs_PDFJSWIDGET',$script,CClientScript::POS_READY);
   }
